// Provided by:   ______Asif Saifullah______(your name here)__________
// Email Address: ____________fsaiful000@citymail.cuny.edu________
// FILE: sequence2.h
...
//		 Postcondition:  copy constructor, copies all the data from the source and 
//		 after that the sequence have the same size, same current fuction from the source.
//		 The insert/ attach function also work efficieantly without allowcationg memory 
//		 untill capacity reached. 
//
...
namespace main_savitch_4
{
	...
	//-- Fill in your private member variables here.
        value_type *data; //-- You'll need a pointer to a dynamic array, and a size_type
        size_type used;//-- variable to keep track of the current length of the
        size_type current_index;// -- sequence, an index to the current item, and 
	                              //-- another size_type variable to keep track of the
		size_type capacity;//-- complete capacity of the dynamic array.
    };
}
